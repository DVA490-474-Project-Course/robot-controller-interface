...
inline ::SimulatorCommand* SimulationSyncRequest::_internal_mutable_simulator_command() {
  ...
  if (simulator_command_ == nullptr) {
    auto* p = CreateMaybeMessage<::SimulatorCommand>(GetArena());
...
inline ::RobotControl* SimulationSyncRequest::_internal_mutable_robot_control() {
  ...
  if (robot_control_ == nullptr) {
    auto* p = CreateMaybeMessage<::RobotControl>(GetArena());
    robot_control_ = p;
  }
...
inline ::RobotControlResponse* SimulationSyncResponse::_internal_mutable_robot_control_response() {
  ...
  if (robot_control_response_ == nullptr) {
    auto* p = CreateMaybeMessage<::RobotControlResponse>(GetArena());
